...
declare -a embedding_model_info=(
 ...
 # "mtr-modernbert-base${DELIMITER}${MTR_ROOT:-/path/to/mtr}/tempfile/model/mtr_moderbert_base/checkpoint-48"
    "ChatQA-Context${DELIMITER}nvidia/dragon-multiturn-query-encoder"
)

# --- Dataset Info (Name${DELIMITER}Path ) ---
declare -a dataset_info=(
 # "mtr${DELIMITER}${MTR_ROOT:-/path/to/mtr}/mtr-data-dumps/mtr_test"
 # "topiocqa${DELIMITER}${HOME_DIR:-/path/to}/datasets/topiocqa"
 # "doc2dial${DELIMITER}${HOME_DIR:-/path/to}/datasets/doc2dial"
 # "qrecc${DELIMITER}${HOME_DIR:-/path/to}/datasets/qrecc"
 # "quac${DELIMITER}${HOME_DIR:-/path/to}/datasets/quac"
    "mtr_finance_filtered${DELIMITER}${MTR_ROOT:-/path/to/mtr}/mtr-data-dumps/finance_filtered-final"
    "mtr_finance_unfiltered${DELIMITER}${MTR_ROOT:-/path/to/mtr}/mtr-data-dumps/finance_unfiltered-final"
)
