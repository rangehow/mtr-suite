#!/bin/bash
source ${BASE_DIR:-/path/to}/env/.bashrc
...
declare -a dataset_configs=(
 ...
 # "full;${MTR_ROOT:-/path/to/mtr}/mtr-data-dumps/finance_filtered-final;mtr_finance_filtered"
 # "full;${MTR_ROOT:-/path/to/mtr}/mtr-data-dumps/finance_unfiltered-final;mtr_finance_unfiltered"
)
...
for (( i=0; i<num_models; i++ )); do
 ...
 # --- ModelExecute Python script ---
    python ${MTR_ROOT:-/path/to/mtr}/eval.py \
